...
const handleclicks=()=>{
  ...
  setImg(selects ===''|| selects==='default'?'':selects2 === 'fahrenheit' ? "/media/fahrent2.png" : selects2== "celsius"?"/media/celsius.png": selects2 ==="kelvin"?"/media/kelvin4.png":selectValid.length>1?'':'')
